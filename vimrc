...
augroup flog
  ...
  autocmd FileType floggraph nmap <buffer> o <CR>
  autocmd FileType floggraph nmap <buffer> p <CR><C-w>lzM<C-w>h
  autocmd FileType floggraph nmap <buffer> git :Git
...
-- Automatically print diagnostics on the command line
