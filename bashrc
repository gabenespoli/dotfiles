...
alias czz="git stash --all"
alias czp="git stash pop"
alias czl="git stash list"
alias glog="git log --graph --date=short --abbrev-commit --pretty=format:'%C(cyan)%cd %C(blue)%h%Creset%C(green)%d%Creset %s %C(italic 8)(%an)%Creset'"
alias gl="glog -15"
alias gll="gl --all"
alias rb="git rebase"
