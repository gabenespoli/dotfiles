# Generated by Powerlevel10k configuration wizard on 2023-12-06 at 09:49 EST.
...
# 2 lines, solid, no frame, black-ornaments, sparse, few icons, concise,
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%12F' # bright blue foreground
      local  untracked='%10F' # bright green foreground
      local conflicted='%13F'  # pink foreground
    else
